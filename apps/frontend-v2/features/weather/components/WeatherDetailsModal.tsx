...
export default function WeatherDetailsModal({ weather, isOpen, onClose }: Props) {
  ...
  // Override condition label if description is available
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm transition-all duration-300">
      ...
      >
        ...
        <div className="mt-2 text-center">
          <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Current Weather</p>
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          ...
          <div className="flex items-center gap-3 rounded-2xl bg-secondary/50 p-3 border border-border/30">
            ...
            <div className="min-w-0">
              <p className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">Humidity</p>
          ...
          <div className="flex items-center gap-3 rounded-2xl bg-secondary/50 p-3 border border-border/30 col-span-2">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">Wind Speed</p>
